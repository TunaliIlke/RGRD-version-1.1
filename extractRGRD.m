...
if inter_size ~= -1
    ...
    maskBorder = interp3dim(maskBorder, round(size(maskBorder,1)/ratio),round(size(maskBorder,2)/ratio),round(size(maskBorder,3)/ratio2))>0.50; 
    maskErode = interp3dim(maskErode, round(size(maskErode,1)/ratio),round(size(maskErode,2)/ratio),round(size(maskErode,3)/ratio2))>0.50; 
    maskTmr = interp3dim(maskTmr, round(size(maskTmr,1)/ratio),round(size(maskTmr,2)/ratio),round(size(maskTmr,3)/ratio2))>0.50; 
    maskOutside2 = interp3dim(maskOutside2, round(size(maskOutside2,1)/ratio),round(size(maskOutside2,2)/ratio),round(size(maskOutside2,3)/ratio2))>0.50; 
end
